      ...
      <view v-if="$store.state.isSignin">
        <view class="margin-xs padding-sm card">
          <view class="flex justify-between align-center">
            <view class="receiving" @click="guide('/pages/mine/receiving')">
              <owl-icon :size="55" :src="require('../../static/icon/mine/wait-goods.png')"></owl-icon>
              <view class="text-sm">待收货</view>
            </view>
            <view class="received" @click="guide('/pages/mine/received')">
              <owl-icon :size="55" :src="require('../../static/icon/mine/after-service.png')"></owl-icon>
              <view class="text-sm">已收货</view>
            </view>
            <view class="cart" @click="guide('/pages/mine/cart')">
              <owl-icon :size="55" :src="require('../../static/icon/mine/cart.png')"></owl-icon>
              <view class="text-sm">购物车</view>
            </view>
            <view class="order" @click="guide('/pages/mine/order')">
              <owl-icon :size="55" :src="require('../../static/icon/mine/order.png')"></owl-icon>
              <view class="text-sm">我的订单</view>
            </view>
          </view>
        </view>
      </view>
