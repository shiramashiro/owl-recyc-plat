<template>
    <view class="society">
        <!-- 爱心捐赠服务 -->
        <owl-fiche :title="'捐赠'" :sub-title="'捐赠书籍的公益'" :icon-path="require('../../assets/icon/society/公益捐赠.png')">
            <view class="donation flex align-center justify-between">
                <view class="school-donation">
                    <navigator :url="'/pages/transfer/more-transfer?type=school'">
                        <image model="aspectFill" src="../../assets/icon/society/学校.png"></image>
                        <view class="text-center">学校</view>
                    </navigator>
                </view>
                <view class="library-donation">
                    <navigator :url="'/pages/transfer/more-transfer?type=library'">
                        <image model="aspectFill" src="../../assets/icon/society/图书馆.png"></image>
            ...
            <view class="item padding-bottom-sm" v-for="(item, index) in posts" :key="index" @click="guid(item.id)">
                ...
                <view class="dynamic-data margin-top-sm flex align-center justify-end">
                    <view class="comment flex align-center text-gray margin-right-sm">
                        <image class="comment-icon" mode="aspectFit" src="../../assets/icon/society/评论.png"></image>
                        <view class="num">
                    ...
                    <view class="like flex align-center text-gray">
                        <image class="like-icon" mode="aspectFit" src="../../assets/icon/society/点赞.png"></image>
                        <view class="num">
